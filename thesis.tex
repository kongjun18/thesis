...
页分配器（page allocator）指按页管理系统内存的分配与释放的内存分配器，是操作系统最基础的组件。本论文的页分配器使用的主要算法是伙伴系统（Binary Buddy Allocator），该算法由 Knowlton 在论文{\cite{knowlton1965fast}} 提出并由 Knuth 在 {\cite{knuth1968art}} 进一步描述。与其他内存分配算法相比，伙伴系统有以下优点：
